...
const RegionsAndCommunesCL: Array<{ "region": string, "communes": string[] }> = [
    ...
    },
    {
        ...
        "communes": ["Talca", "ConsVtución", "Curepto", "Empedrado", "Maule", "Pelarco", "Pencahue", "Río Claro", "San Clemente", "San Rafael", "Cauquenes", "Chanco", "Pelluhue", "Curicó", "Hualañé", "Licantén", "Molina", "Rauco", "Romeral", "Sagrada Familia", "Teno", "Vichuquén", "Linares", "Colbún", "Longaví", "Parral", "ReVro", "San Javier", "Villa Alegre", "Yerbas Buenas"]
    },
    {
    ...
    },
    {
        ...
        "communes": ["Puerto Montt", "Calbuco", "Cochamó", "Fresia", "FruVllar", "Los Muermos", "Llanquihue", "Maullín", "Puerto Varas", "Castro", "Ancud", "Chonchi", "Curaco de Vélez", "Dalcahue", "Puqueldón", "Queilén", "Quellón", "Quemchi", "Quinchao", "Osorno", "Puerto Octay", "Purranque", "Puyehue", "Río Negro", "San Juan de la Costa", "San Pablo", "Chaitén", "Futaleufú", "Hualaihué", "Palena"]
    },
    {
        "region": "Región Aisén del Gral. Carlos Ibáñez del Campo",
        "communes": ["Coihaique", "Lago Verde", "Aisén", "Cisnes", "Guaitecas", "Cochrane", "OHiggins", "Tortel", "Chile Chico", "Río Ibáñez"]
    },
    {
        "region": "Región de Magallanes y de la AntárVca Chilena",
        "communes": ["Punta Arenas", "Laguna Blanca", "Río Verde", "San Gregorio", "Cabo de Hornos (Ex Navarino)", "AntárVca", "Porvenir", "Primavera", "Timaukel", "Natales", "Torres del Paine"]
    },
    {
...
export const addresEmpty: AddressType = {
    country: '',
    state: '',
    city: '',
    neighborhood: '',
...
export default function useAddress() {
    ...
    const getStates = (country: string): string[] => {
        const reg: string[] = RegionsAndCommunesCL.map(function (element) {
            return element.region;
        });
        return reg;
    };

    const getNeighborhood = (country: string, regionSelected: string): string[] => {
        const reg = RegionsAndCommunesCL.map(function (element) {
            return element.region;
        });

        const el = RegionsAndCommunesCL.find(element => element.region === regionSelected);
        const communes: string[] = el ? el.communes : [];
        return communes;
    };

    const convertAddressToString = (address: AddressType) => {
        if (!address) return '';
